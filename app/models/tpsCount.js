...
const maxTps = new mongoose.Schema({
...
maxTps.static({
    ...
    findOneAndUpdateData: function (findObj, updateObj) {
        return this.findOneAndUpdate(findObj, updateObj, {upsert: true, new: true, setDefaultsOnInsert: true});
    },
...
module.exports = mongoose.model("xf-tps-count", maxTps);
